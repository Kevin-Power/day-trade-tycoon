...
export const SCENARIOS: Scenario[] = [
  {
    ...
    name: "8/26 開盤觀察",
    tag: "本週 · 建議先打",
    blurb: "週三實盤前 30 分鐘。開盤 20 秒內急殺至 44,926，再拉回。最慢速，看五檔再出手。",
  ...
  },
  {
    ...
    name: "8/25 早盤下殺",
    tag: "本週 · 停損",
    blurb: "週二教材盤前兩小時。開盤 20 秒殺到 44,422，全日低點 44,210 在 11:00。先練停損。",
  ...
  },
  {
    ...
    name: "8/26 全日大富翁",
    tag: "期末考",
    blurb: "同一支週三教材盤，本金 500 萬、2 倍額度。放慢走完 09:00–13:30，看你能不能守住規則跑完全天。",
