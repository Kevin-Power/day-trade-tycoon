...
export const LESSONS: Lesson[] = [
  {
    ...
    prep: [
      "江波黃虛線＝昨收。站上才考慮先買。",
      "來回 0.32%，第一槍要蓋得過費稅。",
      "本金 100 萬、單檔上限 30 萬。台積電一張 240 萬，這課只看不做。",
      "送單前把停損價填進委託單。沒寫，結算會扣紀律分。",
    ],
    beats: [
      {
        atMinute: 0,
        ...
        hint: "台積電只拿來對照大盤，本金 100 萬買不起。做鴻海，對照昨收，不要在 09:00 追價。",
      },
      {
        atMinute: 1,
  ...
  },
  {
    ...
    prep: [
      "這盤 10:30 結算，全日低點 44,210 要 11:00 才到，這課不是找底，是練砍。",
      "部位先小。活著才有午後 V 轉。",
      "進場同時決定：破哪裡就出。停損價寫在委託單的「停損」欄。",
      "系統不會代你出場。碰到停損還留著，結算會記一次。",
    ],
    beats: [
      {
        atMinute: 0,
